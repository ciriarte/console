...
LRESULT DlgSettingsTabs::OnAdd(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
	...
	tr1::shared_ptr<TabData>	tabData(new TabData(consoleSettings.strShell, consoleSettings.strInitialDir));
...
{
	tr1::shared_ptr<TabData>	tmpData(*(m_tabSettings.tabDataVector.begin() + nItem));
