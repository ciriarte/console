...
typedef map<HTREEITEM, tr1::shared_ptr<DlgSettingsBase> >	SettingsDlgsMap;
...
//		LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	private:
		...
		HTREEITEM AddDialogToTree(const wstring& strName, const tr1::shared_ptr<DlgSettingsBase>& newDlg, CRect& rect, HTREEITEM htiParent = NULL);
